...
# Display the custom logo for book selection
# Apply custom CSS
css = """
<style>
...
df_books = pd.read_csv('data/Books.csv', sep=';', encoding='latin-1')
df_books_ratings = pd.read_csv('data/Book-Ratings-Subset.csv', sep=';', encoding='latin-1')
df_users = pd.read_csv('data/Users.csv', sep=';', encoding='latin-1')
...
if 'Consent' not in st.session_state:
    st.info('This website uses collaborative filtering (friends) and content based filtering (based on reading)')
...
# initializations
friends_list = st.session_state['Friends']
...
st.write('Bookrecom , a prototype online platform for book recommendations.')
